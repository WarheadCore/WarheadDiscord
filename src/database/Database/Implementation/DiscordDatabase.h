...
enum DiscordDatabaseStatements : uint32
{
    ...
    */
    ...
    DISCORD_INS_ACCOUNT,
    DISCORD_SEL_IP_INFO,
    DISCORD_SEL_ACCOUNT_ID_BY_USERNAME,
    DISCORD_SEL_ACCOUNTS,
    DISCORD_UPD_LOGON,

    // Ban manager
    DISCORD_DEL_BAN_ACCOUNT,
    DISCORD_DEL_BAN_IP,
    DISCORD_INS_ACCOUNT_BAN,
    DISCORD_INS_IP_BAN,
    DISCORD_UPD_ACCOUNT_BAN_EXPIRED,
    DISCORD_UPD_IP_BAN_EXPIRED,
